...
export const TextEditor = ({ className, placeholder = "Start typing...", variant = "full" }: { className?: string; placeholder?: string; variant?: "minimal" | "compact" | "full" }) => {
    ...
    const showToolbar = variant === "full" || variant === "compact";
    const showStatusBar = variant === "full";

    const toolbarItems = variant === "compact" ? toolbarGroups.slice(1, 3) : toolbarGroups;
